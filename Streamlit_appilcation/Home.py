...
""")
st.image(r"C:\Users\asus\Downloads\Untitled design.png", caption="Explore Real Estate Trends", use_column_width=True)
# Sidebar navigation
# st.sidebar.title("Navigation")
# page = st.sidebar.radio("Go to", ["Home", "Price Prediction", "Market Analysis", "Recommendations"])
